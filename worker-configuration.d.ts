/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc -c ../auth-sentinel/wrangler.jsonc` (hash: 260912ef1aa5b51e04b04a821c74a1d1)
// Runtime types generated with workerd@1.20250712.0 2025-05-14 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		HASH_PEPPER: string;
		DB: D1Database;
		AUTH_SENTINEL: Service<import("../auth-sentinel/src/index").AuthSentinel>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "LOG_FORMAT" | "ALLOWED_ORIGINS" | "JWT_TOKEN" | "RESEND" | "HASH_PEPPER">> {}
}
